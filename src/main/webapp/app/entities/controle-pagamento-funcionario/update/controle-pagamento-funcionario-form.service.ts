...
type ControlePagamentoFuncionarioFormDefaults = Pick<NewControlePagamentoFuncionario, 'id' | 'funcionarios'>;
...
type ControlePagamentoFuncionarioFormGroupContent = {
  ...
  funcionarios: FormControl<IControlePagamentoFuncionario['funcionarios']>;
};
...
export class ControlePagamentoFuncionarioFormService {
  createControlePagamentoFuncionarioFormGroup(
    ...
    return new FormGroup<ControlePagamentoFuncionarioFormGroupContent>({
      ...
      funcionarios: new FormControl(controlePagamentoFuncionarioRawValue.funcionarios ?? []),
    });
  }
