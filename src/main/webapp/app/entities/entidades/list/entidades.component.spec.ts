...
describe('Entidades Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'entidades', component: EntidadesComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.entidades?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to entidadesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEntidadesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEntidadesIdentifier).toHaveBeenCalledWith(entity);
