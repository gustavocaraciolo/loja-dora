...
type RestOf<T extends IFuncionario | NewFuncionario> = Omit<T, 'dataInicio'> & {
...
export class FuncionarioService {
  ...
  protected convertDateFromClient<T extends IFuncionario | NewFuncionario | PartialUpdateFuncionario>(funcionario: T): RestOf<T> {
    return {
      ...funcionario,
      dataInicio: funcionario.dataInicio?.format(DATE_FORMAT) ?? null,
    };
  }
  ...
  protected convertDateFromServer(restFuncionario: RestFuncionario): IFuncionario {
    return {
      ...restFuncionario,
      dataInicio: restFuncionario.dataInicio ? dayjs(restFuncionario.dataInicio) : undefined,
    };
  }
