...
describe('FluxoCaixa Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'fluxo-caixa', component: FluxoCaixaComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.fluxoCaixas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to fluxoCaixaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFluxoCaixaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFluxoCaixaIdentifier).toHaveBeenCalledWith(entity);
