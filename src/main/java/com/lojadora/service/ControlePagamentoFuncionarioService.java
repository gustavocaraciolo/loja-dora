...
public class ControlePagamentoFuncionarioService {
    ...
    /**
     * Get all the controlePagamentoFuncionarios with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<ControlePagamentoFuncionario> findAllWithEagerRelationships(Pageable pageable) {
        return controlePagamentoFuncionarioRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<ControlePagamentoFuncionario> findOne(Long id) {
        ...
        return controlePagamentoFuncionarioRepository.findOneWithEagerRelationships(id);
    }
