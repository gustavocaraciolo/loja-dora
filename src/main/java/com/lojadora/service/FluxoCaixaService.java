...
public class FluxoCaixaService {
    ...
    /**
     * Get all the fluxoCaixas with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<FluxoCaixa> findAllWithEagerRelationships(Pageable pageable) {
        return fluxoCaixaRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<FluxoCaixa> findOne(Long id) {
        ...
        return fluxoCaixaRepository.findOneWithEagerRelationships(id);
    }
