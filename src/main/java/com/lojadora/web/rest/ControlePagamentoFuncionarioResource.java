...
public class ControlePagamentoFuncionarioResource {
    ...
    public ResponseEntity<List<ControlePagamentoFuncionario>> getAllControlePagamentoFuncionarios(
        ...
        Page<ControlePagamentoFuncionario> page;
        if (eagerload) {
            page = controlePagamentoFuncionarioService.findAllWithEagerRelationships(pageable);
        } else {
            page = controlePagamentoFuncionarioService.findAll(pageable);
        }
