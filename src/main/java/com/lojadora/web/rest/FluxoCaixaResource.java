...
public class FluxoCaixaResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<FluxoCaixa>> getAllFluxoCaixas(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of FluxoCaixas");
        Page<FluxoCaixa> page = fluxoCaixaService.findAll(pageable);
