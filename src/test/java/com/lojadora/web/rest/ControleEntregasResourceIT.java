...
class ControleEntregasResourceIT {
    ...
    void createControleEntregas() throws Exception {
        ...
        assertThat(testControleEntregas.getEndereco()).isEqualTo(DEFAULT_ENDERECO);
    ...
    void putExistingControleEntregas() throws Exception {
        ...
        assertThat(testControleEntregas.getEndereco()).isEqualTo(UPDATED_ENDERECO);
    ...
    void partialUpdateControleEntregasWithPatch() throws Exception {
        ...
        partialUpdatedControleEntregas.endereco(UPDATED_ENDERECO).receita(UPDATED_RECEITA).valor(UPDATED_VALOR);
